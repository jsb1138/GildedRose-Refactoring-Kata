...
type singleTestResult = (string | number)[];
const tests: singleTestResult[] = require("../../test-results.json");
...
describe("Tests for Conjure items", () => {
...
// describe("Generating characterization tests", () => {
